...
def BMI():
    ...
    if bmi<=18.5:
        ...
        label3.config(text="Slightly overweight,Go do some walk noww. ")
        
    else:
        label2.config(text="Obes")
        label3.config(text="Your Health may be at risk.Consult a doc.")
...
#change background colour of scale
style=ttk.Style()
...
secondimage.place(x=70,y=50)



Button(root,text="view report",width=15,height=2,font="arial 10 bold",bg="#1f6e68",command=BMI).place(x=280,y=340)
